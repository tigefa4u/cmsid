...
browser.alert = function(msg, shadow) {
    ...
    $('#alert').html('<div class="title"><span class="close"></span>' + title + '</div><div class="padding"><div class="message">' + msg + '</div></div>');
...
browser.confirm = function(question, callBack) {
    ...
    $('#dialog').html('<div class="box"><div class="padding"><div class="question">' + browser.label(question) + '<div class="buttons"><button>' + browser.label("No") + '</button> <button>' + browser.label("Yes") + '</button></div></div></div></div>');
    browser.showDialog();
...
browser.fileNameDialog = function(e, post, inputName, inputValue, url, labels, callBack, selectAll) {
    var html = '<form method="post" action="javascript:;">' +
        '<div class="box">' +
        '<div class="padding"><input name="' + inputName + '" type="text" />' +
        '<div style="text-align:right">' +
        '<input type="submit" class="button" value="' + _.htmlValue(this.label("OK")) + '" /> ' +
        '<input type="button" class="button" value="' + _.htmlValue(this.label("Cancel")) + '" onclick="browser.hideDialog(); browser.hideAlert(); return false" />' +
    '</div></div></div></form>';
    $('#dialog').html(html);
