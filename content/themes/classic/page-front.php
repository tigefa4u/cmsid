...
$bt = classic_theme_option('limit_post');
...
<?php endif;?>
<p style="text-align:justify;"><?php echo limittxt( sanitize(strip_tags($wFrontArtikel->content)), 300 )?></p></div>

<p class="post-footer">
<a href="<?php echo do_links('post',$dFrontArtikel);?>" rel="bookmark" title="<?php echo $wFrontArtikel->title;?>" class="readmore">Baca Selengkapnya</a>	
<span class="comments">Klik (<?php echo $wFrontArtikel->hits?>)</span>
<span class="waktu_posting"><?php echo datetimes( $wFrontArtikel->date_post, false )?></span>	
</p>
<?php
}
if( !$page_found ):
